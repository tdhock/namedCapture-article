...
Article ([[file:RJwrapper.pdf][local copy]]) accepted at [[https://journal.r-project.org/archive/2019/RJ-2019-050/index.html][R Journal]]. Main
source file to edit is [[file:hocking.Rnw]] and [[file:Makefile]] takes care of
creating [[file:submission.zip]]
