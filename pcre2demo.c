/* -*- compile-command: "make pcre2demo.out" -*- */
...
PCRE2_SPTR pattern;     /* PCRE2_SPTR is a pointer to unsigned code units of */
 PCRE2_SPTR subject;
 const char * pattern_string = "track (?P<trackName>[A-Za-z0-9_]+)";
 char * subject_string;
...
if (argc - i != 1)
  {
  printf("Exactly one argument required: subject file name.\n");
  return 1;
  }
 slurp(argv[i], &subject_string, 0);
...
//subject = (PCRE2_SPTR)argv[i+1];
 ...
 subject = (PCRE2_SPTR)subject_string;
